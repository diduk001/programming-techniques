...
struct Sportsman
{
    ...
    /**
     * @brief Проверяет равенство двух спортсменов (сравнение по ФИО)
    ...
    /**
     * @brief Сравнивает двух спортсменов для сортировки (сравнение по ФИО)
     * @param[other] Спортсмен для сравнения
    ...
    /**
     * @brief Проверяет неравенство двух спортсменов (сравнение по ФИО)
     * @param[other] Спортсмен для сравнения
