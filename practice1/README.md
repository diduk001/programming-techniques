...
Отчет генерируется из ссылки на репозиторий, [README.md](./README.md) графика и документации скриптом [report.py](./tests/report.py) и сохраняется в [report.pdf](./report.pdf)
